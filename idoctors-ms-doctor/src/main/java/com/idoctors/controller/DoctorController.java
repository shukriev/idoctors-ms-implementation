package com.idoctors.controller;
...
import com.idoctors.resource.assembler.DoctorResourceAssembler;
import com.idoctors.resource.assembler.DoctorSpecialityResourceAssembler;
import com.idoctors.service.DoctorService;
import com.idoctors.service.DoctorSpecialityService;
...
public class DoctorController {
    ...
    @PreAuthorize("#oauth2.hasScope('read', 'write') and hasRole('ROLE_USER')")
